...
def download_all(sites):
    with concurrent.futures.ProcessPoolExecutor() as executor: # max_workers = 5 for this example 描
        executor.map( download_one, sites ) # map = map, apply = apply_async, 这里apply_async = 返
